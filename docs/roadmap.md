...
Milestone 1 targets Flutter and Dart on Windows desktop, using Riverpod, GoRouter, and Drift over SQLite for local persistence. The desktop shell, capture-first persistence, and optional Idea Group organization are implemented, but other milestone work remains open.

Implementation progress as of 2026-08-08:
